...
**Action Required**: All Mainnet node operators must upgrade their nodes to **v1.xx [TBD]** before the activation time on [DATE_TBD].

The Avalanche Granite Upgrade includes protocol optimizations that are not compatible with AvalancheGo versions < v1.xx [TBD]. If you run a node on Mainnet, you must upgrade your software to AvalancheGo >= v1.xx [TBD] before the scheduled activation time. Ensure your node is running with the correct plugin version as specified in the [release notes](https://github.com/ava-labs/avalanchego/releases).
...
Fuji node operators must upgrade their nodes to **v1.xx-fuji [TBD]** prior to **11 AM ET (3 PM UTC) on Wednesday, October 29th, 2025**. The pre-release includes protocol optimizations that are not compatible with AvalancheGo versions < v1.xx.x-fuji [TBD]. The plugin version is unchanged at 39 and is compatible with version v1.xx.x [TBD].
...
[Watch the ACP-181 community call](https://www.youtube.com/watch?v=1c6Qa1sobQg) to learn more about the technical details.
...
[Watch the ACP-226 community call](https://www.youtube.com/watch?v=v792NyX58sI) to learn more about the technical implementation.
...
1. **`proposervm.GetProposedHeight`** - Returns this node's current proposer VM height.
   - [Documentation](https://github.com/ava-labs/avalanchego/blob/7fd85c437985a57731a271c28ea5ed3d25c089e6/vms/proposervm/service.md#proposervmgetproposedheight)

2. **`proposervm.GetCurrentEpoch`** - Returns the current epoch information.
   - [Documentation](https://github.com/ava-labs/avalanchego/blob/7fd85c437985a57731a271c28ea5ed3d25c089e6/vms/proposervm/service.md#proposervmgetcurrentepoch)

3. **`platform.GetAllValidatorsAt`** - Get the validators and their weights of all Subnets and the Primary Network at a given P-Chain height.
   - [Documentation](https://github.com/ava-labs/avalanchego/blob/master/vms/platformvm/service.md#platformgetallvalidatorsat)
