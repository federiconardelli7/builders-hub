...
Fuji node operators must upgrade their nodes to **v1.14-fuji** prior to **11 AM ET (3 PM UTC) on Wednesday, October 29th, 2025**. The pre-release includes protocol optimizations that are not compatible with AvalancheGo versions < v1.14-fuji. The plugin version is updated to 44 and is compatible with version v1.13.0.
