...
<p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.95rem', color: '#666' }}>
  Learn from pitch coach and performer <a href="https://margovandelinde.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#0066cc', textDecoration: 'underline' }}>Margo van der Linde</a>
</p> 
