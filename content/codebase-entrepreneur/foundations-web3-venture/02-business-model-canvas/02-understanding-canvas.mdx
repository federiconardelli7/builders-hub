...
<span style={{ fontWeight: 'bold' }}>"'If you build it they will come is not a strategy.' That is a maxim that I would argue does not hold real weight."</span> - Michael Martin, Codebase Lead at Ava Labs
</div>
</Callout>
