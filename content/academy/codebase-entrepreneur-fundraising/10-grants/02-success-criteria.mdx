...
<div style={{ margin: '2rem 0' }}>
  ...
  <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.95rem', color: '#666' }}>
    Learn from Xenia Soborova, ex-Ecosystem Coordinator at Avalanche Foundation
  </p>
</div>
