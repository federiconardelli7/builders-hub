...
```bash
forge create --rpc-url local-c --private-key $PK --broadcast --constructor-args 18 lib/icm-contracts/contracts/ictt/mocks/ExampleERC20Decimals.sol:ExampleERC20Decimals
```
...
```bash
forge create --rpc-url local-c --private-key $PK --broadcast --constructor-args $ICM_REGISTRY_C_CHAIN $FUNDED_ADDRESS $ERC20_HOME_C_CHAIN 18 lib/icm-contracts/contracts/ictt/TokenHome/ERC20TokenHome.sol:ERC20TokenHome
```
...
```bash 
forge create --rpc-url myblockchain --private-key $PK --broadcast --constructor-args "($ICM_REGISTRY_L1, $FUNDED_ADDRESS, $C_CHAIN_BLOCKCHAIN_ID_HEX, $ERC20_HOME_TRANSFERER_C_CHAIN, 18)" "EXMP.b" 100000000000000000000 0 false 0 lib/icm-contracts/contracts/ictt/TokenRemote/NativeTokenRemote.sol:NativeTokenRemote
```
