...
<span style={{ fontWeight: 'bold' }}>"You should treat off-chain data as trustless, which means that you cannot rely on data off-chain. But you can have some kind of proof of computation or some kind of proof of validity of that data on-chain"</span> - Martin Prado, Chief Information Security Officer at Ava Labs
</div>
</Callout>
