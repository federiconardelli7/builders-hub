...
export function Container({
  ...
  return (<>
    <div className="mb-12 relative bg-gradient-to-r from-transparent via-red-50/30 to-red-100/50 dark:from-transparent dark:via-red-950/20 dark:to-red-900/30 rounded-2xl p-6 -m-6">
